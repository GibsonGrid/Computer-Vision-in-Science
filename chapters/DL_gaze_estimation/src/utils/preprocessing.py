...
root = os.path.join(project_root, "data/original/MPIIFaceGaze")
sample_root = os.path.join(project_root, "data/original/MPIIGaze/Evaluation Subset/sample list for eye image")
out_root = os.path.join(project_root, "data/preprocessed/MPIIFaceGaze")
